...
with open('fan_data_threshold.csv') as csv_file:
  ...
  for row in csv_reader:
    ...
    # If the current value is different from the previous one, and the 
    # new value is 0, it means the light value has gone from 1 to 0.
    ...
    if current_light_value != old_light_value and current_light_value == 0:
      blade_count += 1    
  ...
  print(f'Found {blade_count} transitions.')
